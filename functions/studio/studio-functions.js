...
function reverseCharacters(strToReverse) {
  ...
  if (typeof strToReverse === 'string') {
    ...
    return Number(String(strToReverse).split('').reverse().join(''));
  }    
}
let strToReverse = "'apple','LC101','Capitalized Letters','I love the smell of code in the morning.'";
...
function reverseArray(oldArray) {
  ...
  for (let i = 0; i < oldArray.length; i++) {
      let reversedString = reverseCharacters(oldArray[i]);
...
console.log(`The area is ${rectangleArea(2,4)} cm^2`);
console.log(`The area is ${rectangleArea(14,7)} cm^2`);
console.log(`The area is ${rectangleArea(20)} cm^2`);