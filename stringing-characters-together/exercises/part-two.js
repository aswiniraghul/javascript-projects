...
let dna2=dna.toUpperCase();

console.log("The letters in dna string to uppercase is ",dna2);
...
console.log("The altered strand is",dnaReplace);

//2) Look for the gene "CAT" with ``indexOf()``. If found print, "CAT gene found", otherwise print, "CAT gene NOT found".

let findGene = "CAT";
if (dnaTwo.indexOf(findGene) !== -1) {
