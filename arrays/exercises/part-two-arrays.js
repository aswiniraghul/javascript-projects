...
let removedLastItem = cargoHold.pop();
console.log(`removed last item is ${removedLastItem}`);
console.log(cargoHold);


//3) Remove the first item from the array with shift. Print the element removed and the updated array.
console.log(`removed first item is ${cargoHold.shift()}`);
console.log(cargoHold);
...
console.log(`The array ${cargoHold} has the length ${cargoHold.length}`);